          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex items-center gap-3 w-full max-w-md">
              ...
              <button
                ...
                disabled={!hasToken}
                className="whitespace-nowrap rounded-full bg-emerald-600 px-6 py-2 text-sm font-bold text-white transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:bg-gray-200 dark:disabled:bg-gray-700 shadow-lg shadow-emerald-600/20"
              >
