...
export default function TeamPostPage() {
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      setIsPostModalOpen(false);
      setPostContent('');
      router.push(`/forums/team/${teamId}/threads/${threadId}/posts/${body.id}`);
    } catch (err: any) {
  ...
  const handleUpdatePost = async () => {
    ...
    try {
      ...
      setIsEditModalOpen(false);
      setEditContent('');
      router.push(`/forums/team/${teamId}/threads/${post.thread?.id ?? threadId}/posts/${body.id}`);
    } catch (err: any) {
  ...
  const handleDeletePost = async () => {
    ...
    openConfirm('Delete post?', 'This will hide it for everyone.', async () => {
      ...
      try {
        ...
        router.push(`/forums/team/${teamId}/threads/${post.thread?.id ?? threadId}`);
      } catch (err: any) {
      ...
      <header className="relative overflow-hidden border-b border-gray-200/50 dark:border-gray-800 bg-white/80 dark:bg-[#1f2937]/80 backdrop-blur-xl">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-12">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-4 text-sm font-medium text-gray-500 dark:text-gray-400">
            ...
            <Link
              href={`/forums/team/${teamId}/threads/${post.thread?.id ?? threadId}`}
              className="rounded-full border border-emerald-200/50 dark:border-emerald-900/30 bg-emerald-50 dark:bg-emerald-900/20 px-4 py-1.5 font-bold text-emerald-700 dark:text-emerald-400 hover:bg-emerald-100 dark:hover:bg-emerald-900/40 transition"
            >
              {threadTitle}
            </Link>
          </div>
          <div className="mt-8 flex flex-wrap items-center gap-3">
            <button
              ...
              onClick={() =>
                previousVersionId &&
                router.push(`/forums/team/${teamId}/threads/${post.thread?.id ?? threadId}/posts/${previousVersionId}`)
              }
            ...
            <button
              ...
              onClick={() =>
                nextVersionId &&
                router.push(`/forums/team/${teamId}/threads/${post.thread?.id ?? threadId}/posts/${nextVersionId}`)
              }
            ...
            <span className="flex items-center gap-2">
              ...
              {post.author?.username ? (
                <button
                  ...
                  className="text-emerald-600 hover:text-emerald-500 dark:text-emerald-400 dark:hover:text-emerald-300 font-bold hover:underline transition-colors"
                >
                  @{post.author.username}
                </button>
              ) : (
        ...
        <section className={`rounded-3xl relative overflow-hidden p-8 shadow-sm backdrop-blur-sm transition-all duration-300 ${
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
            ...
            {(post.previousVersionId || post.nextVersionId) && (
              <button
                ...
                className="text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 hover:text-emerald-800 dark:hover:text-emerald-300 transition"
              >
          ...
          <div className="mt-8 flex flex-wrap items-center gap-3 border-t border-gray-100 dark:border-gray-800/50 pt-6">
            ...
            <button
              ...
              disabled={!hasToken}
              className="inline-flex items-center gap-2 rounded-full border border-emerald-200/50 dark:border-emerald-900/50 bg-emerald-50/50 dark:bg-emerald-900/20 px-5 py-2.5 text-xs font-bold uppercase tracking-wider text-emerald-600 dark:text-emerald-400 transition hover:bg-emerald-100 dark:hover:bg-emerald-900/40 disabled:cursor-not-allowed disabled:opacity-50 shadow-sm"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-4 h-4">
                  ...
                  <div className="mt-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between border-t border-gray-100 dark:border-gray-800/50 pt-4">
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={!hasToken}
                        className="inline-flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider text-gray-400 hover:text-emerald-600 dark:hover:text-emerald-400 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3.5 h-3.5">
                          <path fillRule="evenodd" d="M7.707 3.293a1 1 0 010 1.414L5.414 7H11a7 7 0 017 7v2a1 1 0 11-2 0v-2a5 5 0 00-5-5H5.414l2.293 2.293a1 1 0 11-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z" clipRule="evenodd" />
                        </svg>
            ...
            <div className="mt-6 space-y-6">
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={6}
                  className="w-full rounded-2xl border border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/30 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 placeholder:text-gray-400 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 focus:outline-none transition-all"
                />
              </div>
              {postCreateError && (
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 dark:border-gray-800">
                ...
                <button
                  ...
                  className="rounded-full bg-emerald-600 dark:bg-emerald-500 px-8 py-2.5 text-xs font-bold uppercase tracking-widest text-white transition hover:bg-emerald-700 dark:hover:bg-emerald-400 disabled:cursor-not-allowed disabled:bg-gray-200 dark:disabled:bg-gray-700 shadow-lg shadow-emerald-600/20"
                >
