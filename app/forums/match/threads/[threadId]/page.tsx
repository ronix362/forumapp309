          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                disabled={!hasToken}
                className="rounded-full bg-sky-600 dark:bg-sky-500 px-5 py-2.5 text-sm font-bold tracking-wide text-white transition hover:bg-sky-700 dark:hover:bg-sky-400 disabled:cursor-not-allowed disabled:bg-gray-200 dark:disabled:bg-gray-700 disabled:text-gray-500 dark:disabled:text-gray-400 shadow-sm"
              >
