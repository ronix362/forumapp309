...
export default function GeneralThreadPage() {
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col gap-6 px-6 py-12">
          ...
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-4 flex items-center gap-2 text-sm font-medium text-gray-500 dark:text-gray-400">
                ...
                {thread.author && (
                  <>
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-amber-600 hover:text-amber-500 dark:text-amber-400 dark:hover:text-amber-300 transition-colors"
                    >
              ...
              <div className="flex flex-wrap items-center justify-end gap-2">
                {isAdmin && (
                  <button
                    ...
                    className="rounded-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-[#1f2937] px-4 py-2 text-sm font-semibold text-gray-700 dark:text-gray-200 transition hover:bg-gray-50 dark:hover:bg-gray-800 shadow-sm"
                  >
                    Edit thread
                  </button>
                )}
            ...
            {deleteError && <p className="mt-4 text-sm text-red-600 dark:text-red-400 font-medium">{deleteError}</p>}
          </div>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-6xl px-6 py-12 space-y-16">
        <section className="space-y-6">
          ...
          {thread?.mainPost && thread.mainPost.visibility !== false ? (
            <div className="relative overflow-hidden rounded-3xl border border-amber-200/50 dark:border-amber-900/40 bg-gradient-to-br from-amber-50/50 to-white dark:from-amber-900/10 dark:to-[#1f2937]/50 p-8 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-lg group">
              <Link
                href={`/forums/general/threads/${thread.id}/posts/${thread.mainPost.id}`}
                className="absolute inset-0 z-0"
              />
              <div className="pointer-events-none absolute top-0 right-0 rounded-bl-3xl bg-gradient-to-r from-amber-500 to-amber-600 px-5 py-2 text-[10px] font-bold uppercase tracking-widest text-white shadow-sm z-10">
                Original Post
              </div>
              ...
              <div className="relative z-10 mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-amber-100 dark:border-amber-900/30 pt-4 pointer-events-none">
                  ...
                  {thread.mainPost.author && (
                    <>
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1 text-amber-600 hover:text-amber-500 dark:text-amber-400 dark:hover:text-amber-300 transition-colors pointer-events-auto"
                      >
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="flex items-center gap-3 w-full max-w-md">
              ...
              <button
                ...
                disabled={!hasToken}
                className="whitespace-nowrap rounded-full bg-amber-600 px-6 py-2 text-sm font-bold text-white transition hover:bg-amber-700 disabled:cursor-not-allowed disabled:bg-gray-300 dark:disabled:bg-gray-700 shadow-lg shadow-amber-600/20"
              >
                ...
                const renderPost = (node: PostRecord, depth: number) => {
                  ...
                  return (
                    <div key={node.id} style={{ marginLeft: depth * 24 }}>
                      <Link
                        href={`/forums/general/threads/${thread.id}/posts/${node.id}`}
                        className="block"
                      >
          ...
          {pollsLoading ? (
            ...
            <div className="space-y-4">
              {pollsOnPage.map((poll) => (
                <Link
                  key={poll.id}
                  href={`/forums/general/threads/${thread.id}/polls/${poll.id}`}
                  className="block"
                >
                  <article className="rounded-3xl border border-gray-200/50 dark:border-gray-800 bg-white/70 dark:bg-[#1f2937]/50 p-6 shadow-sm backdrop-blur-sm transition-all duration-300 hover:shadow-md group">
                    <h3 className="text-xl font-bold text-gray-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 transition-colors">{poll.pollDescription}</h3>
                      ...
                      {poll.author && (
                        <>
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 text-amber-600 hover:text-amber-500 dark:text-amber-400 dark:hover:text-amber-300 transition-colors pointer-events-auto font-bold uppercase"
                          >
